    ...
    <div class="mb-5" v-if="next">
      ...
      <div class="row g-3 mt-3">
        <div class="col-md-6">
          <div class="form-group">
            <label>Марка</label>
            <select v-model="brand" name="" class="form-select"></select>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>Модель</label>
            <select v-model="model" name="" class="form-select"></select>
          </div>
        </div>
      ...
      <div class="sub-title fw-bold">Внутренние</div>
      ...
      <h2>Фотографии</h2>
      <div class="sub-title fw-bold">Снаружи</div>
      ...
      <div class="sub-title fw-bold">Салон</div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group py-1">
            ...
            <input class="form-check-input mx-1" type="checkbox" v-model="functions_check" id="functions_check">
          </div>
        </div>
    ...
    previewFiles(event) {
      if (event.target.getAttribute('data-subfield'))
        if (event.target.getAttribute('data-index'))
          this[event.target.getAttribute('data-field')][event.target.getAttribute('data-index')][event.target.getAttribute('data-subfield')] = event.target.files[0]
        else
          this[event.target.getAttribute('data-field')][event.target.getAttribute('data-subfield')] = event.target.files[0]
      else if (event.target.getAttribute('data-index'))
        this[event.target.getAttribute('data-field')][event.target.getAttribute('data-index')] = event.target.files[0]
      else
        this[event.target.getAttribute('data-field')] = event.target.files[0]
    }
  }
}
</script>
